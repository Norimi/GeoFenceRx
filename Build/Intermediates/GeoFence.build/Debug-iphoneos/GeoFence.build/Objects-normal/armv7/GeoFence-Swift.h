...
SWIFT_CLASS("_TtC8GeoFence11AppDelegate")
...
SWIFT_CLASS("_TtC8GeoFence32RxCLLocationManagerDelegateProxy")
...
SWIFT_CLASS("_TtC8GeoFence14ViewController")
...
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified geoLabel;
- (void)viewDidLoad;
- (void)initializeRxDelegateMethods SWIFT_METHOD_FAMILY(none);
- (void)setupLocationManager;
- (void)regionMonitoring;
- (void)getLocation;
- (void)fireNotification;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresent:(UNNotification * _Nonnull)notification withCompletionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
